...
state distinction for simplicity.
...
| `node`               | `container`, `header`, `headerTitle`, `headerActionIcon`, `body`, `outputsSection`, `outputRow`, `inputsSection`, `inputRow`, `panelHeader`, `panelContent`, `inputField`, `handleShape` | ConfigurableNode + handles + inputs; `inputField` also reaches drawer fields and runner sliders                                                                                                                                                                                                                       |
...
| `runnerPanel`        | `container`, `resizeHandle`, `closeButton`                                                                                                                                               | NodeRunnerPanel                                                                                                                                                                                                                                                                                                       |
